...
{
    public partial class MainViewModel : ObservableObject, IDocumentManager
    {
        ...
        public MainViewModel(IServiceProvider serviceProvider, IDialogService dialogService, ISettingsService settingsService, ViewModelFactory documentFactory)
        {
